...
public class AccountCrudControllerIT {
    ...
    @Test
    public void shouldReturnAllAccountsWhenFindAll() throws Exception {
        when(accountRepositoryStub.findAll()).thenReturn(asList(new Account(1, new BigDecimal("1.11")),
        ...
        mockMvc.perform(get("/api/account"))
                ...
                .andExpect(jsonPath("$[0].amount").value("1.11"))
                .andExpect(jsonPath("$[1].amount").value("2.22"));
    }

    @Test
    public void shouldReturnAccountWhenFindById() throws Exception {
        when(accountRepositoryStub.findById(3)).thenReturn(new Account(3, new BigDecimal("1.11")));
    ...
    @Test
    public void shouldReturnExceptionWhenFindById() throws Exception {
        when(accountRepositoryStub.findById(4)).thenReturn(null);

        mockMvc.perform(get("/api/account/4"))
